    ...
    <footer className="footer">
      <div className="footer__left">
        ...
        <div className="footer__info"> 
          ...
          <p className="text-p text-color--50">© 2026 Narime — All rights reserved</p>
        </div>
      </div>

      <div className="footer-social">
        <div className="footer-social__icons">
          <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="var(--color-white)" className="icon-size-xl footer-social__icons-item">
        ...
        <p className="text-p text-color--50">Support: narime@support.com</p>
      </div>
    </footer>
  )
}
