...
const MenuSetting = ({ isOpen, onClose }: Props) => {
  ...
  return (
    <div className="popover-panel menu-settings__container" ref={menuRef}>
      ...
      <Link className="text-btn text-color--75 menu--settings--item" to="/user-page" onClick={() => onClose?.()}> 
      ...
      <button className="text-btn text-color--75 menu--settings--item" onClick={() => handleLogOut()}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="var(--color-white-50)" className="size-6 icon-size-m">
