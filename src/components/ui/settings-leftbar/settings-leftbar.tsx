      ...
      <Link to="/user-page" className="text-details text-color--50">Go back</Link>
        ...
        <div className="settings-nav__section">
          ...
          <button className="action-item">
            ...
            <p className="text-p text-color--75">Public Profile</p>
          </button>
          ...
          <button className="action-item">
            ...
            <p className="text-p text-color--75">Language</p>
          </button>
          ...
          <button className="action-item">
            ...
            <p className="text-p text-color--75">Aparence</p>
          </button>
        </div>
        ...
        <div className="settings-nav__section">
          ...
          <button className="action-item">
            ...
            <p className="text-p text-color--75">Privacity</p>
          </button>
          ...
          <button className="action-item">
            ...
            <p className="text-p text-color--75">Change Password</p>
          </button>
        </div>
      </nav>
  )
