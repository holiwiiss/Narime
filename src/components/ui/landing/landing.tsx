    ...
    <>
      <section className="landing-header">
        <div className="landing-header__text">
          ...
          <h1 className="text-h1 landing-header__title">YOUR ANIME. YOUR HISTORY. <span className=" text-h1 landing-header__title text-color--primary"> IN ONE PLACE </span></h1>
      ...
      <main className="landing-main">
        ...
        <section className="landing-features">
          <header className="landing-section__header">
            <h2 className="text-h2 landing-h2">Features</h2>
            <p className="text-p text-color--75">Thousands of episodes, one single list. Keep your anime <br/>experience organized from start to finish.</p>
          </header>
        ...
        <section className="landing-screens">
          <header className="landing-section__header">
            <h2 className="text-h2 landing-h2">See narime in action</h2>
          ...
          <div className="landing-screens__content">
            <ul className="landing-screens--options">
              ...
              <li className={`landing-screens--options--item ${activeBtn === "mylist" ? "landing--item-active" : ""}`} onClick={() => {setActiveBtn("mylist"); setCurrentImage(myListImg)}}>
                <h3 className="text-h3 landing-h3">My List</h3>
              ...
              <li className={`landing-screens--options--item ${activeBtn === "profile" ? "landing--item-active" : ""}`} onClick={() => {setActiveBtn("profile"); setCurrentImage(profileImg)}}>
                <h3 className="text-h3 landing-h3">Profile</h3>
