  ...
  return (
    <>
      {!animeInfo ? (
        ...
        <button className={`btn action-item anime-page__btn ${userData ? "btn--secondary" : ""}`}
          ...
          >
            {userData ? (
              ...
              <span className="text-btn action-item__text anime-page__text-btn">Edit Anime</span>
              </>
            ):(
              <>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="var(--color-white)" className="size-6 action-item__icon" aria-hidden="true">
                ...
                <span className="text-btn action-item__text anime-page__text-btn">Add to your list</span>
              </>
            )}
          </button>
      </>
